...
Pinned version: **4.6.5** (WSC2026 / WorldSkills 2026 Web Technologies)
...
**What it does:** Serves the CodeIgniter4 welcome app via `php spark serve`. Bundled MySQL 8.4.

**Open / use:** http://localhost:8080
